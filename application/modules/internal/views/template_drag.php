...
<head>
    ...
    <!-- notification css -->
    <link rel="stylesheet" href="<?= theme() ?>/plugins/nestable-master/css/nestable.min.css">
    <!-- vendor css -->
...
<body>
    ...
    <script src="<?= theme() ?>/plugins/nestable-master/js/jquery.nestable.js"></script>
    <!-- <script src="<?= theme() ?>/js/pages/ac-nestable.js"></script> -->

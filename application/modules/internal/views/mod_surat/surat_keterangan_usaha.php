...
<body>
	...
	<table width="100%">
		<tr><td colspan="4" align="center"><b style="margin:0px;"><u>SURAT KETERANGAN USAHA</u></b><br><label>Nomor : B- 193 / 511.3 / VI / KD / 2021</label></td></tr>
		<tr><td><br></td></tr>
		...
		<tr>
			...
			<td align="left">: <?= $rows['sku_keperluan']?></td>
		</tr>
		<tr><td><br></td></tr>
		<tr>
			<td colspan="4">
		...
		<tr>
			...
			<td align="left">: <b>"<?= $rows['sku_nama_usaha']?>"</b></td>
		</tr>
		<tr>
			<td width="10%"></td>
			<td >Jenis Usaha</td>
			
			<td align="left">: <?= $rows['sku_jenis_usaha']?></td>
		</tr>
		<tr>
			<td width="10%"></td>
			<td >Alamat Usaha</td>
		
			<td align="left">: <?= $rows['sku_alamat_usaha']?></td>
		</tr>
		<?php $lama = date('Y') - date('Y',strtotime($rows['sku_tanggal_berdiri']));?>
		<tr>
			<td width="10%"></td>
			<td >Lama Usaha</td>
			
			<td align="left">: <?= $lama ?> (<?= terbilang($lama)?> ) Tahun, pada tanggal <?= date('d/m/Y',strtotime($rows['sku_tanggal_berdiri']))?></td>
		</tr>
